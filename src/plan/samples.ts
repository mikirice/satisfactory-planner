...
export const SAMPLE_PLANS: readonly SamplePlan[] = [
  ...
  },
  {
    ...
    guide: {
      sections: {
        ...
        tips: [
          '4つの代替レシピは、ハードドライブ解析で入手します。',
          '起動時は最初の1周ぶんのプラスチックとゴムを手動投入してください。',
          '燃料の配管が満ちてから製油所を順に動かすと、停止原因を追いやすくなります。',
        ],
      },
    },
    snapshot: {
  ...
  },
  {
    ...
    guide: {
      sections: {
        mechanism: [
          '原油を「廃重油」レシピで処理し、廃重油を多く取り出します。',
          '廃重油と水をブレンダーへ送り、「希釈燃料」で燃料へ増量します。',
          'できた燃料を燃料式発電機へ送り、連続して発電します。',
        ],
        tips: [
          '「廃重油」と「希釈燃料」は、ハードドライブ解析で入手する代替レシピです。',
    ...
    guide: {
      sections: {
        mechanism: [
          ...
          '燃料と圧縮石炭を製油所へ入れ、「ターボ燃料」を作ります。',
          'ターボ燃料を燃料式発電機へ送り、少ない燃料流量で発電します。',
        ],
        tips: [
          '「圧縮石炭」と「ターボ燃料」は、ハードドライブ解析で入手する代替レシピです。',
  ...
  },
  {
    ...
    guide: {
      sections: {
        ...
        tips: [
          '「廃重油」と「希釈された容器入り燃料」は、ハードドライブ解析で入手します。',
  ...
  },
  {
    ...
    guide: {
      ...
      circulationMeaning:
        'バッテリー製造で生じる水をアルミナ溶液へ戻します。下の数値は、外から汲まずに済む循環水量です。',
    },
    snapshot: {
      ...DEFAULTS,
      n: 'バッテリー製造（水循環）',
    ...
    guide: {
      sections: {
        mechanism: [
          ...
          'FICSONIUM燃料棒を発電に使い、長い核廃棄物の流れを最後まで処理します。',
        ],
        tips: [
